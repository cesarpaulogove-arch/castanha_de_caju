...
export default async function TransportadoresPage() {
  ...
  const transportadores = await prisma.usuario.findMany({
    where: {
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-4 text-sm leading-6 text-[#806b55]">
                Consulte os transportadores cadastrados
                na plataforma.
              </p>
            </div>
          ...
          {transportadores.length === 0 ? (
            <div className="rounded-3xl border border-dashed border-[#dfceb4] bg-white p-12 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-[#806b55]">
                ...
                com o perfil de transportador, ele aparecerá
                    ...
                    {transportadores.map((transportador) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-5 text-sm text-[#806b55]">
                          ...
                          ).format(transportador.createdAt)}
                        </td>
                      </tr>
                    ))}
                  </tbody>
